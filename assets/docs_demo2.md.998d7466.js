import{_ as s,o as a,c as n,a as l}from"./app.8bdf5597.js";const F=JSON.parse('{"title":"demo2","description":"","frontmatter":{},"headers":[{"level":2,"title":"title1","slug":"title1","link":"#title1","children":[]},{"level":2,"title":"title2","slug":"title2","link":"#title2","children":[]}],"relativePath":"docs/demo2.md"}'),e={name:"docs/demo2.md"},p=l(`<h1 id="demo2" tabindex="-1">demo2 <a class="header-anchor" href="#demo2">¶</a></h1><div class="tip custom-block"><p class="custom-block-title">Testing Is Documentation</p><p><a href="https://github.com/hunzhiwange/framework/blob/master/tests/Kernel/Utils/Assert/Doc/Demo2.php" target="_blank" rel="noreferrer">tests/Kernel/Utils/Assert/Doc/Demo2.php</a></p></div><p>demo doc just test</p><h2 id="title1" tabindex="-1">title1 <a class="header-anchor" href="#title1">¶</a></h2><p>hello world</p><h2 id="title2" tabindex="-1">title2 <a class="header-anchor" href="#title2">¶</a></h2><p>hello world</p><div class="language-php"><button title="Copy Code" class="copy"></button><span class="lang">php</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;">&lt;?</span><span style="color:#A6ACCD;">php</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    </span><span style="color:#89DDFF;">}</span></span>
<span class="line"><span style="color:#89DDFF;">}</span></span>
<span class="line"></span></code></pre></div>`,8),t=[p];function o(c,r,i,y,D,C){return a(),n("div",null,t)}const h=s(e,[["render",o]]);export{F as __pageData,h as default};
